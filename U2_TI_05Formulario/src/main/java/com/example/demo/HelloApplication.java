...
public class HelloApplication extends Application {
    ...
    public void start(Stage primaryStage){
        ...
        BtnCrear.setOnAction(e -> {
            ...
            if (!nombre.isEmpty() || !apellido.isEmpty() || !edad.isEmpty() || tipoUsuario != null) {
                grid.setStyle("-fx-background-color: lightgreen; -fx-padding: 20;");
                labelResultado.setStyle("-fx-background-color: lightblue; -fx-padding: 10;");
                labelResultado.setText("Nombre:\n" + nombre + ".\nApellido:\n" + apellido + "\nEdad:\n" + edad + "\nTipoUsuario\n" + tipoUsuario);
            }else {
